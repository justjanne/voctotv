...
sealed interface FeaturedItem {
    data class Lecture(val lecture: LectureModel) : FeaturedItem
    data class Stream(val conference: LiveConferenceModel, val rooms: List<LiveRoomModel>) : FeaturedItem
}
